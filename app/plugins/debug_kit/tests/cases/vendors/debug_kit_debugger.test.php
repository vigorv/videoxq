 ...
 **/
	function testTimers() {
		...
		// the timer uses getMicrotime, whicht will round it's returnvalue to 4 places. 
		// This might cause rounding errors on this test, therefore we have to pass it, even if the timevalue is slightly lower than expected.
		$this->assertTrue($elapsed > 0.0045);
