...
<?php echo $form->create('User');?>
    ...
    <?php
        ...
        echo $form->text('birthday_search');
...
<div class="actions">
    <ul>
        <li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('User.userid')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('User.userid'))); ?></li>
