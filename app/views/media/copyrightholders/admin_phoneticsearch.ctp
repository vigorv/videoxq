...
<div><a href="/admin/copyrightholders/phoneticbuildbase" class="a_btn">Создание/обновление фонетического словаря для правообладателей</a></div>
<div id="logo"></div>
</div>
<?php echo $autocomplete->autocomplete('FilmTitle','CopyrightholdersPhonetic/word',null,30,4); ?>
