	    ...
	    $panelContent .= '</td>
	        ...
	        <td class="title">' . $ahref . __('All Files', true) . '</td>
       		<td width="100%">
       			...
       			<iframe id="cloudLinkframe" onload="return cloudFrameResult(this);" valign="center" visible="false" width="0" height="0" frameborder="0" scrolling="no" marginwidth="0px" marginheight="0px"></iframe>
       		</td>
	    	</tr>
	    ';
/*
