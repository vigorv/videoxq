...
<!--
        <div id="news_ID" class="news_item">
            ...
            <div class="news_content">
                <a href="/img/about/9may.jpg" rel="fancybox" onclick="return stopdivx();"><img class="news_content_img"  height="120px" src="/img/about/9may.jpg"></a>
         ...
         <div id="news_ID" class="news_item">
            ...
            <div class="news_content">
                <a href="/img/about/basket_arena.jpg" rel="fancybox" onclick="return stopdivx();"><img class="news_content_img" height="100px" width="160px" src="/img/about/basket_arena.jpg"></a>
...
<?php
	if (!empty($lst))
	{
		foreach ($lst as $l)
		{
			if (!empty($l['News']['img']))
			{
				$img = '<a href="/files/news/' . $l['News']['img'] . ' rel="fancybox"><img class="news_content_img"  height="120px" src="/files/news/' . $l['News']['img'] . '"></a>';
			}
			else
				$img = '';
			echo'
