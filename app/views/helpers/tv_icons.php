...
class TvIconsHelper extends AppHelper {
    ...
    public function AllIcons()
    {
        ...
        "number_6" => array("name" => "number_6", "title" => "Вид отображения: По шесть", "path" => "/img/main/number_6.png", "class" => "icon_number6", "style" => "", "event" => "onclick='switchOn(this); return saveOption(\"Profile.itemsPerPage\", \"6\");'"),
        "number_9" => array("name" => "number_9", "title" => "Вид отображения: По девять", "path" => "/img/main/number_9.png", "class" => "icon_number9", "style" => "", "event" => "onclick='switchOn(this); return saveOption(\"Profile.itemsPerPage\", \"9\");'"),
        "number_12" => array("name" => "number_12", "title" => "Вид отображения: По двенадцать", "path" => "/img/main/number_12.png", "class" => "icon_number12", "style" => "", "event" => "onclick='switchOn(this); return saveOption(\"Profile.itemsPerPage\", \"12\");'"),
        "number_24" => array("name" => "number_24", "title" => "Вид отображения: По двадцать четыре", "path" => "/img/main/number_24.png", "class" => "icon_number24", "style" => "", "event" => "onclick='switchOn(this); return saveOption(\"Profile.itemsPerPage\", \"24\");'")
        );
    }
