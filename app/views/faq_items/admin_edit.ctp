...
<?php echo $form->create('FaqItem');?>
	<fieldset>
 		<legend><?php __('Edit FaqItem');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('FaqItem.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('FaqItem.id'))); ?></li>
