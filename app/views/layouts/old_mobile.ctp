...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
    ...
    <body style=" margin:0;color:#333;font-size:13px;font-family:sans-serif;background-color:#fff;width:100%;" >
        ...
        <div style="border-top:1px solid #999;font-size:80%;background:#EEE;text-align:center">
            ...
            <table cellpadding=0 cellspacing=0 border=0><tr><td><a href="http://www.branica.com/"><img id="counter" src="http://counters.branica.com/?i=0&u=true&ox=10&oy=17&c=000000&b=yellow.png&f=Terminator.ttf&fn=true&w=110&h=35&s=10" alt="Branica" width="110" height="35" style="border:none"/><br><font color="#838383" size="-3"></a></font></td></tr></table>
