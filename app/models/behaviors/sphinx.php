...
class SphinxBehavior extends ModelBehavior
{
     ...
     */
    var $runtime = array();
    var $_defaults = array('server' => '127.0.0.1', 'port' => 3312);
    ...
    function setup(&$model, $config = array())
    {
        ...
        $settings = array_merge($defaults, (array)$config);
...
////////////
        ...
        if ($result === false)
        {
            trigger_error("Search query failed: ".serialize($this->settings[$model->alias]['server'])." " . $this->runtime[$model->alias]['sphinx']->GetLastError());
            return false;
        }
