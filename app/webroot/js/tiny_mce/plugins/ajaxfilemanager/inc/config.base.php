...
//error_reporting(E_ALL ^ E_NOTICE);
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../../webroot/img/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../../../webroot/img/');	//accept relative path only
	...
	define('CONFIG_WEBSITE_DOCUMENT_ROOT', '/var/www/html/app/webroot/');
